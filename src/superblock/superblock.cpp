...
void print_superblock(Superblock *superblock)
{
    ...
    cout << "mount time:  "; print_time((unsigned)superblock->s_mtime);
    cout << "write time:  "; print_time((unsigned)superblock->s_wtime);
    ...
    cout << "time of last check:  "; print_time((unsigned)superblock->s_lastcheck);
